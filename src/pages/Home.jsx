...
import { blogPosts, testimonials, features } from '../mock';
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold mb-4">
                From Our <span className="text-yellow-500">Blog</span>
              </h2>
              <p className="text-xl text-gray-400">Latest insights on Bitcoin education and adoption</p>
            </div>
            <Link 
              to="/blog" 
